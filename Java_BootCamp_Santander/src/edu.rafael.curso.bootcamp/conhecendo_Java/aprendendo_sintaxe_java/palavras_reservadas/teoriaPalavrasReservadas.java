package edu.rafael.curso.bootcamp.conhecendo_Java.aprendendo_sintaxe_java.palavras_reservadas;

public class teoriaPalavrasReservadas {
    /* Controle de Pacotes
    ...
    *Primitivos
    ...
    hort: um inteiro de 32 bits (signed);

    void: indica que o método não tem retorno de valor

    *Modificadores de classe, Acesso, Variáveis e Métodos
    ...
    *Controle de fluxo dentro de um bloco de codigo
    ...
    return: retorna um método sem executar qualquer código, que venha depois desta 
